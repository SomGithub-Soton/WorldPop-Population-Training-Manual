---
title: 'Module 1: Basics of R Programming'
output:
  html_document: 
      toc: true
      toc_float: true
...
setwd("/Volumes/worldpop/Projects/WP000008_UNFPA_THA_Phase2/Working/Pop_Modelling_Training_Manual/Module1")
#working directory for windows
# setwd("/Projects/WP000008_UNFPA_THA_Phase2/Working/Pop_Modelling_Training_Manual/Module1")
```
...
knitr::include_graphics("images/rdownload enlarged.png")
```
...
knitr::include_graphics("images/rdownload windows enlarged.png")
```
...
knitr::include_graphics("images/rdownload mac enlarged.png")
```
...
knitr::include_graphics("images/rstudio download windows.png")
```
...
knitr::include_graphics("images/rstudio download mac.png")
```
...
knitr::include_graphics("images/empty RGui.png")
```
...
knitr::include_graphics("images/annotated RGui.png")
```
...
```{r, echo=FALSE, fig.align='center', out.width="80%", fig.cap = "Annotated RStudio GUI"}
knitr::include_graphics("images/RStudio GUI key.png")
```
...
knitr::include_graphics("images/Rstudio newscript.png")
```
...
knitr::include_graphics("images/Rstudio openscript.png")
```
...
knitr::include_graphics("images/Rstudio savescript.png")
```
...
knitr::include_graphics("images/RStudio setwd.png")
```
...
knitr::include_graphics("images/create proj1.png")
```
...
```{r, echo=FALSE, fig.align='center', out.width="80%", fig.cap = "Annotated RStudio GUI: Create project"}
knitr::include_graphics("images/create proj2.png")
```
...
knitr::include_graphics("images/open proj.png")
```
...
```{r, echo=FALSE, fig.align='center', out.width="80%", fig.cap = "Annotated RStudio GUI: Help files"}
knitr::include_graphics("images/RStudio cheatsheets.png")
```
