---
title: "Module 2: Working with Data Frames"
output:
  html_document: 
    toc: true
    toc_float: true
...
setwd("/Volumes/worldpop/Projects/WP000008_UNFPA_THA_Phase2/Working/Pop_Modelling_Training_Manual/Module2")
data_path <- "/Volumes/worldpop/Projects/WP000008_UNFPA_THA_Phase2/Working/Pop_Modelling_Training_Manual/data/"
pic_path <-"/Volumes/worldpop/Projects/WP000008_UNFPA_THA_Phase2/Working/Pop_Modelling_Training_Manual/Module2/images/"


#working directory for windows
# setwd("/Projects/WP000008_UNFPA_THA_Phase2/Working/Pop_Modelling_Training_Manual/Module2")
# data_path <- "/Projects/WP000008_UNFPA_THA_Phase2/Working/Pop_Modelling_Training_Manual/data/"
# pic_path <-"/Projects/WP000008_UNFPA_THA_Phase2/Working/Pop_Modelling_Training_Manual/Module2/images/"
```
...
knitr::include_graphics("images/import data toolbar.png")
```  
...
knitr::include_graphics("images/import data environment.png")
```
...
knitr::include_graphics("images/view data environment.png")
```  
...
knitr::include_graphics("images/view data tab.png")
```  
...
knitr::include_graphics("images/annotated view plots.png")
```  
...
knitr::include_graphics("images/export plots.png")
```  
